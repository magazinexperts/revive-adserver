...
public class OpenAdsApiXmlRpcProxy {
	...
	public Map[] agencyZoneStatistics(Integer id, Date startDate, Date endDate, Boolean useLocalTimeZone)
			throws XmlRpcException {
		verifyLogon();
		return agencyService.agencyZoneStatistics(id, startDate, endDate, useLocalTimeZone);
	}
	...
	public Map[] agencyAdvertiserStatistics(Integer id, Date startDate,
		...
		verifyLogon();
		return agencyService.agencyAdvertiserStatistics(id, startDate, endDate, useLocalTimeZone);
	}
	...
	public Map[] agencyBannerStatistics(Integer id, Date startDate, Date endDate, Boolean useLocalTimeZone)
			throws XmlRpcException {
		verifyLogon();
		return agencyService.agencyBannerStatistics(id, startDate, endDate, useLocalTimeZone);
	}
	...
	public Map[] agencyPublisherStatistics(Integer id, Date startDate,
			Date endDate, Boolean useLocalTimeZone) throws XmlRpcException {
		verifyLogon();
		return agencyService.agencyPublisherStatistics(id, startDate, endDate, useLocalTimeZone);
	}
	 ...
	 *             the xml rpc exception
	 */
	public Map[] campaignZoneStatistics(Integer id, Date startDate, Date endDate, Boolean useLocalTimeZone)
			throws XmlRpcException {
		verifyLogon();
		return campaignService.campaignZoneStatistics(id, startDate, endDate, useLocalTimeZone);
	}
	...
	public Map[] campaignBannerStatistics(Integer id, Date startDate,
			Date endDate, Boolean useLocalTimeZone) throws XmlRpcException {
		verifyLogon();
		return campaignService.campaignBannerStatistics(id, startDate, endDate, useLocalTimeZone);
	}
	...
	public Map[] campaignDailyStatistics(Integer id, Date startDate,
			Date endDate, Boolean useLocalTimeZone) throws XmlRpcException {
		verifyLogon();
		return campaignService.campaignDailyStatistics(id, startDate, endDate, useLocalTimeZone);
	}
	 ...
	 *             the xml rpc exception
	 */
	public Map[] bannerZoneStatistics(Integer id, Date startDate, Date endDate, Boolean useLocalTimeZone)
			throws XmlRpcException {
		verifyLogon();
	 ...
	 *             the xml rpc exception
	 */
	public Map[] bannerDailyStatistics(Integer id, Date startDate, Date endDate, Boolean useLocalTimeZone)
			throws XmlRpcException {
		verifyLogon();
	...
	public Map[] bannerPublisherStatistics(Integer id, Date startDate,
			Date endDate, Boolean useLocalTimeZone) throws XmlRpcException {
		verifyLogon();
		return bannerService.bannerPublisherStatistics(id, startDate, endDate, useLocalTimeZone);
	}
	...
	public Map[] zoneAdvertiserStatistics(Integer id, Date startDate,
			Date endDate, Boolean useLocalTimeZone) throws XmlRpcException {
		verifyLogon();
		return zoneService.zoneAdvertiserStatistics(id, startDate, endDate, useLocalTimeZone);
	}
	...
	public Map[] zoneBannerStatistics(Integer id, Date startDate, Date endDate, Boolean useLocalTimeZone)
			throws XmlRpcException {
		verifyLogon();
		return zoneService.zoneBannerStatistics(id, startDate, endDate, useLocalTimeZone);
	}
	 ...
	 *             the xml rpc exception
	 */
	public Map[] zoneCampaignStatistics(Integer id, Date startDate, Date endDate, Boolean useLocalTimeZone)
			throws XmlRpcException {
		verifyLogon();
		return zoneService.zoneCampaignStatistics(id, startDate, endDate, useLocalTimeZone);
	}
	...
	public Map[] zoneDailyStatistics(Integer id, Date startDate, Date endDate, Boolean useLocalTimeZone)
			throws XmlRpcException {
		verifyLogon();
		return zoneService.zoneDailyStatistics(id, startDate, endDate, useLocalTimeZone);
	}
	...
	public Map[] publisherZoneStatistics(Integer id, Date startDate,
			Date endDate, Boolean useLocalTimeZone) throws XmlRpcException {
		verifyLogon();
		return publisherService.publisherZoneStatistics(id, startDate, endDate, useLocalTimeZone);
	}
	...
	public Map[] publisherDailyStatistics(Integer id, Date startDate,
			Date endDate) throws XmlRpcException {
		verifyLogon();
		return publisherService.publisherDailyStatistics(id, startDate, endDate);
	}
